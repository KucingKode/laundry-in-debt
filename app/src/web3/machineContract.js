...
const REQUEST_APPROVAL_METHOD = "function setApprovalForAll(address,bool)";

let contract;
let isApproved;

export async function initMachineContract() {
	contract = await getContract(MACHINE_EDITION_ADDRESS);
}
